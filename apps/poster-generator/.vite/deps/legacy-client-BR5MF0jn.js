import {
  ...
  W as create_fragment,
  X as is_firefox,
  Y as init_operations,
  Z as merge_text_nodes,
  _t as flushSync,
  a as get,
  gn as push,
  hn as pop,
  in as set_signal_status,
  kr as TEXT_CACHE,
...
import {
  ...
  m as lifecycle_double_unmount,
  p as legacy_recursive_reactive_block,
  y as state_proxy_unmount,
} from "./warnings-DgKzYu-a.js";
import { t as async_mode_flag } from "./flags-0VUX__9w.js";
import {
  c as on,
  s as handle_event_propagation,
  t as all_registered_events,
  u as root_event_handles,
} from "./events-BVfP088G.js";
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/dom/reconciler.js
var policy =
  ...
  return () => {
    ...
    if (node === void 0) {
      node = fragment_from_tree(
        structure,
        (flags & 4) !== 0 ? NAMESPACE_SVG : (flags & 8) !== 0 ? NAMESPACE_MATHML : void 0,
      );
      if (!is_fragment) node = /* @__PURE__ */ get_first_child(node);
    }
    var clone =
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/render.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/dom/legacy/event-modifiers.js
/**
...
//#endregion
export {
  create_fragment_from_html as A,
  from_html as C,
  props_id as D,
  from_tree as E,
  is_raw_text_element as F,
  is_void as I,
  normalize_attribute as L,
  can_delegate_event as M,
  hash as N,
  text as O,
  is_capture_event as P,
  sanitize_location as R,
  comment as S,
  from_svg as T,
  set_text as _,
  run as a,
  append as b,
  passive as c,
  stopImmediatePropagation as d,
  stopPropagation as f,
  set_should_intro as g,
  mount as h,
  handlers as i,
  create_trusted_html as j,
  with_script as k,
  preventDefault as l,
  hydrate as m,
  createBubbler as n,
