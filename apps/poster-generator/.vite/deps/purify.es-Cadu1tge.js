//#region ../../node_modules/.deno/dompurify@3.4.13/node_modules/dompurify/dist/purify.es.mjs
...
function createDOMPurify() {
  ...
  const getOwnerDocument =
    Node && Node.prototype ? lookupGetter(Node.prototype, "ownerDocument") : null;
  ...
  const _neutralizeSubtree = function _neutralizeSubtree(root) {
    ...
    while (stack.length > 0) {
      ...
      if ((getNodeType ? getNodeType(node) : node.nodeType) === NODE_TYPE.element)
   ...
   *   else set unchanged
   */
  const _forkSharedAllowlist = function _forkSharedAllowlist(
    hookList,
    set,
    defaultSet,
    setConfigSet,
  ...
  const _sanitizeElements = function _sanitizeElements(currentNode, root) {
    ...
    if (
      (getNodeType ? getNodeType(currentNode) : currentNode.nodeType) === NODE_TYPE.element &&
