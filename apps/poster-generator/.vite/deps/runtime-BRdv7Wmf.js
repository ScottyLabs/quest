import {
  b as svelte_boundary_reset_noop,
  d as hydration_mismatch,
  n as await_reactivity_loss,
  o as derived_inert,
  r as await_waterfall,
  v as state_proxy_equality_mismatch,
} from "./warnings-DgKzYu-a.js";
import {
  a as legacy_mode_flag,
  o as tracing_mode_flag,
  t as async_mode_flag,
} from "./flags-0VUX__9w.js";
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/constants.js
/**
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/errors.js
/**
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/shared/warnings.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/shared/clone.js
  ...
  if (typeof value === "object" && value !== null) {
    ...
    if (get_prototype_of(value) === object_prototype) {
      ...
      for (var key of Object.keys(value))
        copy[key] = clone(value[key], cloned, `${path}.${key}`, paths, null, no_tojson);
      return copy;
    }
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/dev/tracing.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/shared/dev.js
/**
 * @param {string} label
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/error-handling.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/store/utils.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/dom/elements/misc.js
/**
      ...
      (evt) => {
        Promise.resolve().then(() => {
          if (!evt.defaultPrevented)
            for (const e of evt.target.elements) /** @type {any} */ e[FORM_RESET_HANDLER]?.();
        });
      },
      { capture: true },
    );
...
function listen_to_event_and_reset_event(element, event, handler, on_reset = handler) {
  ...
  else /** @type {any} */ element[FORM_RESET_HANDLER] = () => on_reset(true);
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/reactivity/async.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/reactivity/deriveds.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/proxy.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/client/dev/equality.js
...
function get(signal) {
  ...
  if (
    ...
    (reactivity_loss_tracker.effect.f & 2097152) === 0 &&
...
//#endregion
export {
  should_defer_append as $,
  invalid_snippet as $n,
  derived$1 as $t,
  remove_effect_dom as A,
  hydrating as An,
  array_from as Ar,
  save as At,
  child as B,
  HYDRATION_ERROR as Bn,
  is_function as Br,
  add_form_reset_listener as Bt,
  effect_root as C,
  trace as Cn,
  LEGACY_PROPS as Cr,
  derived_safe_equal as Ct,
  managed as D,
  hydrate_next as Dn,
  STATE_SYMBOL as Dr,
  for_await_track_reactivity_loss as Dt,
  legacy_pre_effect_reset as E,
  safe_not_equal as En,
  REACTION_RAN as Er,
  flatten as Et,
  user_effect as F,
  set_hydrating as Fn,
  get_descriptor as Fr,
  pending as Ft,
  create_text as G,
  bind_invalid_checkbox_value as Gn,
  run_all as Gr,
  mark_store_binding as Gt,
  create_comment as H,
  NAMESPACE_MATHML as Hn,
  noop as Hr,
  remove_textarea_child as Ht,
  user_pre_effect as I,
  skip_nodes as In,
  get_descriptors as Ir,
  createSubscriber as It,
  get_next_sibling as J,
  each_key_duplicate as Jn,
  store_mutate as Jt,
  first_child as K,
  component_api_changed as Kn,
  to_array as Kr,
  setup_stores as Kt,
  validate_effect as L,
  ATTACHMENT_KEY as Ln,
  get_prototype_of as Lr,
  listen as Lt,
  resume_effect as M,
  read_hydration_instruction as Mn,
  define_property as Mr,
  unset_context as Mt,
  teardown as N,
  reset as Nn,
  exclude_from_object as Nr,
  wait as Nt,
  move_effect as O,
  hydrate_node as On,
  STYLE_CACHE as Or,
  ...
  set_hydrate_node as Pn,
  fallback as Pr,
  boundary as Pt,
  set_attribute as Q,
  hydration_failed as Qn,
  update_store as Qt,
  $document as R,
  FILENAME as Rn,
  has_own_property as Rr,
  listen_to_event_and_reset_event as Rt,
  effect as S,
  tag_proxy as Sn,
  IS_XHTML as Sr,
  derived as St,
  legacy_pre_effect as T,
  dynamic_void_element_content as Tn,
  MAYBE_DIRTY as Tr,
  capture as Tt,
  create_element as U,
  NAMESPACE_SVG as Un,
  object_keys as Ur,
  capture_store_binding as Ut,
  clear_text_content as V,
  NAMESPACE_HTML as Vn,
  is_promise as Vr,
  autofocus as Vt,
  create_fragment as W,
  UNINITIALIZED as Wn,
  run$1 as Wr,
  invalidate_store as Wt,
  is_firefox as X,
  get_abort_signal_outside_reaction as Xn,
  store_unsub as Xt,
  init_operations as Y,
  each_key_volatile as Yn,
  store_set as Yt,
  merge_text_nodes as Z,
  hydratable_missing_but_required as Zn,
  update_pre_store as Zt,
  branch as _,
  setContext as _n,
  EFFECT_TRANSPARENT as _r,
  flushSync as _t,
  get as a,
  queue_micro_task as an,
  ...
  createContext as cn,
  snippet_without_render_tag as cr,
  mutate as ct,
  tick as d,
  getAllContexts as dn,
  ATTRIBUTES_CACHE as dr,
  state as dt,
  get$1 as en,
  lifecycle_legacy_only as er,
  sibling as et,
  untrack as f,
  getContext as fn,
  CLASS_CACHE as fr,
  ...
  block as g,
  push as gn,
  EFFECT_OFFSCREEN as gr,
  eager as gt,
  aborted as h,
  pop as hn,
  DIRTY as hr,
  current_batch as ht,
  deep_read_state as i,
  set_signal_status as in,
  experimental_async_required as ir,
  proxy as it,
  render_effect as j,
  next as jn,
  deferred as jr,
  track_reactivity_loss as jt,
  pause_effect as k,
  hydrate_template as kn,
  TEXT_CACHE as kr,
  run_after_blockers as kt,
  set_active_reaction as l,
  dev_current_component_function as ln,
  store_invalid_shape as lr,
  set as lt,
  invalidate_inner_signals as m,
  is_runes as mn,
  DESTROYING as mr,
  Batch as mt,
  active_reaction as n,
  readonly as nn,
  props_rest_readonly as nr,
  strict_equals as nt,
  is_destroying_effect as o,
  add_svelte_meta as on,
  invalid_snippet_arguments as or,
  internal_set as ot,
  update_version as p,
  hasContext as pn,
  DESTROYED as pr,
  ...
  component_api_invalid_new as qn,
  store_get as qt,
  deep_read as r,
  writable as rn,
  rune_outside_svelte as rr,
  is as rt,
  safe_get as s,
  component_context as sn,
  lifecycle_outside_component as sr,
  mutable_source as st,
  active_effect as t,
  readable as tn,
  props_invalid_value as tr,
  equals as tt,
  settled as u,
  dev_stack as un,
  svelte_element_invalid_this_value as ur,
  source as ut,
  component_root as v,
  set_dev_current_component_function as vn,
  FORM_RESET_HANDLER as vr,
  fork as vt,
  effect_tracking as w,
  snapshot as wn,
  LOADING_ATTR_SYMBOL as wr,
  user_derived as wt,
  eager_effect as x,
  tag as xn,
  INERT as xr,
  async_derived as xt,
  deferred_template_effect as y,
  get_error as yn,
  HEAD_EFFECT as yr,
  is_flushing_sync as yt,
  $window as z,
  HMR as zn,
  is_array as zr,
  without_reactive_context as zt,
};
