...
import { Ct as raf, St as loop } from "./index-client-BFDy9c_o.js";
import { linear } from "./svelte_easing.js";
import { t as MediaQuery } from "./index-client-DO5dy7IB.js";
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/motion/utils.js
/**
 * @param {any} obj
 * @returns {obj is Date}
 */
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/motion/spring.js
...
function tick_spring(ctx, last_value, current_value, target_value) {
  if (typeof current_value === "number" || is_date(current_value)) {
    ...
    const d =
      (velocity + (ctx.opts.stiffness * delta - ctx.opts.damping * velocity) * ctx.inv_mass) *
      ctx.dt;
...
function spring(value, opts = {}) {
  ...
  function set(new_value, opts = {}) {
    ...
    if (value == null || opts.hard || (spring.stiffness >= 1 && spring.damping >= 1)) {
      ...
      inv_mass_recovery_rate = 1 / ((opts.soft === true ? 0.5 : +opts.soft) * 60);
      inv_mass = 0;
    }
    if (!task) {
      last_time = raf.now();
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/motion/tweened.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/motion/index.js
/**
