...
//#region ../../node_modules/.deno/cssesc@3.0.0/node_modules/cssesc/cssesc.js
...
//#endregion
//#region ../../node_modules/.deno/font-family-papandreou@0.2.0-patch2/node_modules/font-family-papandreou/index.js
var require_font_family_papandreou = /* @__PURE__ */ __commonJSMin((exports, module) => {
  var PLAIN = 0;
  var STRINGS = 1;
  var ESCAPING = 2;
  var IDENTIFIER = 3;
  ...
  var parse = function (str) {
    ...
    while (true) {
      ...
      if (state === PLAIN)
        ...
        if (/[0-9a-f]/i.test(c)) throw new Error("Parse error");
        else {
          buffer += c;
          state = IDENTIFIER;
        }
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/path_parse.js
var require_path_parse = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function isSpace(ch) {
    return (
      ...
      ch === 12 ||
      ch === 160 ||
      (ch >= 5760 && SPECIAL_SPACES.indexOf(ch) >= 0)
    );
  }
  ...
  function scanParam(state) {
    ...
    if (ch !== 46) {
      ...
      if (zeroFirst && index < max) {
        if (ch && isDigit(ch)) {
          state.err =
            "SvgPath: numbers started with `0` such as `09` are illegal (at pos " + start + ")";
          return;
        }
      }
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/matrix.js
var require_matrix = /* @__PURE__ */ __commonJSMin((exports, module) => {
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/transform_parse.js
var require_transform_parse = /* @__PURE__ */ __commonJSMin((exports, module) => {
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/a2c.js
var require_a2c = /* @__PURE__ */ __commonJSMin((exports, module) => {
  var TAU = Math.PI * 2;
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/ellipse.js
var require_ellipse = /* @__PURE__ */ __commonJSMin((exports, module) => {
  var epsilon = 1e-10;
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/lib/svgpath.js
var require_svgpath$1 = /* @__PURE__ */ __commonJSMin((exports, module) => {
    ...
    this.iterate(function (s, index, x, y) {
      ...
      switch (s[0]) {
        ...
        case "A":
          ...
          if (e.isDegenerate()) result = [s[0] === "a" ? "l" : "L", p[0], p[1]];
          else result = [s[0], e.rx, e.ry, e.ax, s[4], s[5], p[0], p[1]];
          break;
        case "m":
          isRelative = index > 0;
  ...
  SvgPath.prototype.iterate = function (iterator, keepLazyStack) {
    ...
    for (i = 0; i < segments.length; i++)
      if (typeof replacements[i] !== "undefined")
        for (j = 0; j < replacements[i].length; j++) newSegments.push(replacements[i][j]);
    ...
    this.iterate(function (s, index, x, y) {
      ...
      switch (name) {
        ...
        case "a":
          ...
          return;
        default:
          for (i = 1; i < s.length; i++) s[i] += i % 2 ? x : y;
      }
    }, true);
    return this;
  };
...
//#endregion
//#region ../../node_modules/.deno/svgpath@2.6.0/node_modules/svgpath/index.js
var require_svgpath = /* @__PURE__ */ __commonJSMin((exports, module) => {
  module.exports = require_svgpath$1();
});
//#endregion
//#region ../../node_modules/.deno/specificity@0.4.1/node_modules/specificity/dist/specificity.mjs
var import_cssesc = /* @__PURE__ */ __toESM(require_cssesc());
var import_font_family_papandreou = /* @__PURE__ */ __toESM(require_font_family_papandreou());
var import_svgpath = /* @__PURE__ */ __toESM(require_svgpath());
/**
...
var calculateSingle = function (input) {
  ...
  return {
    selector: input,
    specificity:
      "0," + typeCount.a.toString() + "," + typeCount.b.toString() + "," + typeCount.c.toString(),
...
//#endregion
//#region ../../node_modules/.deno/svg2pdf.js@2.7.0/node_modules/svg2pdf.js/dist/svg2pdf.es.min.js
var l = function (t, e) {
  return (
    (l =
  ...
  return (
    ...
    (t.prototype.getHelpXML = function () {
      for (var e = [], r = 0; r < this.colorDefs.length; r++)
        for (var i = this.colorDefs[r].example, n = 0; n < i.length; n++) e[e.length] = i[n];
  ...
  return (
    (t.prototype.clone = function () {
      ...
      return (
        ...
        (e.color = this.color),
        (e.fillRule = this.fillRule),
        (e.contextFill = this.contextFill),
        (e.contextStroke = this.contextStroke),
        e
      );
    }),
    (t.default = function () {
      ...
      return (
        ...
        (e.color = new p("rgb(0, 0, 0)")),
        (e.fillRule = "nonzero"),
        (e.contextFill = null),
        (e.contextStroke = null),
        e
      );
    }),
    (t.getContextColors = function (t, e) {
      ...
      var r = {};
      return (
        t.attributeState.contextFill && (r.contextFill = t.attributeState.contextFill),
        t.attributeState.contextStroke && (r.contextStroke = t.attributeState.contextStroke),
        e && t.attributeState.color && (r.color = t.attributeState.color),
        r
      );
    }),
    t
...
var g = (function () {
  function t(t, e) {
    ...
    ((this.pdf = t),
      ...
      (this.attributeState = e.attributeState ? e.attributeState.clone() : m.default()),
      (this.viewport = e.viewport),
      (this.refsHandler = e.refsHandler),
      (this.styleSheets = e.styleSheets),
      (this.textMeasure = e.textMeasure),
      (this.transform = null !== (r = e.transform) && void 0 !== r ? r : this.pdf.unitMatrix),
      (this.withinClipPath = null !== (i = e.withinClipPath) && void 0 !== i && i),
...
var b = (function () {
  ...
  return (
    (e.prototype.getRendered = function (t, e, r) {
      return f(this, void 0, void 0, function () {
        var i, n;
            ...
            case 0:
              return (
                ...
                this.renderedElements.hasOwnProperty(i)
                  ...
                  : ((n = this.get(t)), (this.renderedElements[i] = n), [4, r(n)])
              );
            case 1:
              return (a.sent(), [2, n]);
          }
    ...
    (e.prototype.get = function (e) {
      return this.idMap[(0, import_cssesc.default)(e, { isIdentifier: !0 })];
    }),
    (e.prototype.generateKey = function (t, e) {
      var r = "";
      return (
        e &&
          (r = ["color", "contextFill", "contextStroke"]
            .map(function (t) {
              var r, i;
              return null !== (i = null === (r = e[t]) || void 0 === r ? void 0 : r.toRGBA()) &&
                void 0 !== i
                ? i
                : "";
            })
...
var v = 2 / 3;
function x(t, e) {
  return [v * (e[0] - t[0]) + t[0], v * (e[1] - t[1]) + t[1]];
}
function S(t) {
...
function N(t, e, r, i) {
  ...
  if (a) return a;
  return e.getPropertyValue(t, i) || (t.hasAttribute(r) && t.getAttribute(r)) || void 0;
}
function O(t, e, r) {
      ...
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (u) {
          switch (u.label) {
            ...
            case 1:
              return e < this.markers.length
                ? ((r = this.markers[e]),
                  ...
                  (s = Math.cos(n)),
                  (o = Math.sin(n)),
                  (i = t.pdf.Matrix(s, o, -o, s, a[0], a[1])),
                  (i = t.pdf.matrixMult(
                    t.pdf.Matrix(
            ...
            case 2:
              (u.sent(),
                t.pdf.doFormObject(t.refsHandler.generateKey(r.id, l), i),
...
function $(t, e, r, i, n, a, s, o) {
  ...
  if (
    ("none" !== l &&
      ("meet" === u ? (d = m = Math.min(d, m)) : "slice" === u && (d = m = Math.max(d, m))),
    o)
  )
    return s.pdf.Matrix(d, 0, 0, m, 0, 0);
  var y = r - h * d,
    v = i - f * m;
  (l.indexOf("xMid") >= 0 ? (y += (n - c * d) / 2) : l.indexOf("xMax") >= 0 && (y += n - c * d),
    l.indexOf("YMid") >= 0 ? (v += (a - p * m) / 2) : l.indexOf("YMax") >= 0 && (v += a - p * m));
  var x = s.pdf.Matrix(1, 0, 0, 1, y, v),
...
function Q(t, e) {
  ...
  for (
    ...
    if (
      (f &&
        ((r = j(f[1])),
        (h = e.pdf.matrixMult(e.pdf.Matrix(r[0], r[1], r[2], r[3], r[4], r[5]), h)),
      ...
      if (
        ((h = e.pdf.matrixMult(
          e.pdf.Matrix(Math.cos(c), Math.sin(c), -Math.sin(c), Math.cos(c), 0, 0),
          h,
        )),
        r[1] || r[2])
      ) {
  ...
  return (
    ...
    (e.prototype.apply = function (t) {
      return f(this, void 0, void 0, function () {
        var e, r, a, s, o, l;
        return c(this, function (u) {
          return (e = this.element.getAttribute("id"))
            ? ((r = this.getStops(t.styleSheets)),
              (a = 0),
              (s = !1),
              ...
              s && (o = new O$1({ opacity: a / r.length })),
              (l = new M$1(this.pdfGradientType, this.getCoordinates(), r, o)),
              t.pdf.addShadingPattern(e, l),
              [2])
            : [2];
        });
      });
          ...
          if ("stop" === i.element.tagName.toLowerCase()) {
            var n = N(i.element, t, "color"),
              s = G(
                ...
                n ? { color: G(n, null) } : { color: r.contextColor },
              ),
          ...
          switch (a.label) {
            ...
            case 1:
              return (
                ...
                "objectboundingbox" !==
                  this.gradient.element.getAttribute("gradientUnits").toLowerCase()
                  ? (r = e.pdf.unitMatrix)
                  : ((i = t.getBoundingBox(e)), (r = e.pdf.Matrix(i[2], 0, 0, i[3], i[0], i[1]))),
                (n = Q(
                  N(this.gradient.element, e.styleSheets, "gradientTransform", "transform"),
                  e,
                )),
                [
                  2,
        ...
        return c(this, function (o) {
          switch (o.label) {
            case 0:
              ...
              ((r = this.getBoundingBox(t)),
                (i = new q$1([r[0], r[1], r[0] + r[2], r[1] + r[3]], r[2], r[3])),
                t.pdf.beginTilingPattern(i),
                (n = 0),
                (s = this.children),
                (o.label = 1));
            case 1:
            ...
            case 1:
              return (
                ...
                this.pattern.element.hasAttribute("patternContentUnits") &&
                  ...
                  (r.yStep = h)),
                (f = e.pdf.unitMatrix),
                (p = N(this.pattern.element, e.styleSheets, "patternTransform", "transform")) &&
                  (f = Q(p, e)),
                (d = a),
                (d = e.pdf.matrixMult(d, n)),
                (d = e.pdf.matrixMult(d, f)),
                (d = e.pdf.matrixMult(d, e.transform)),
                (r.matrix = d),
                [2, r]
              );
          }
...
function at(t, e) {
  ...
  if (r) {
    ...
    return n && (n instanceof tt || n instanceof et)
      ? (function (t, e, r) {
          ...
          if (1 === i.length) {
            var n = i[0].color,
              a = new p();
            return (
              (a.ok = !0), (a.r = n[0]), (a.g = n[1]), (a.b = n[2]), (a.a = i[0].opacity), new d(a)
            );
          }
          return new rt(t, e);
        })(i, n, e)
...
function st(t, r, i) {
  ...
  (m &&
    t.attributeState.stroke instanceof d &&
    (t.attributeState.contextStroke = t.attributeState.stroke.color),
    l &&
      t.attributeState.fill instanceof d &&
      (t.attributeState.contextFill = t.attributeState.fill.color));
  ...
  if (T) {
    var F = import_font_family_papandreou.default.parse(T);
...
function ot(t, e, r) {
  ...
  if (
    (B(r, "use")
      ...
      : t.withinUse &&
        (t.attributeState.fill !== e.attributeState.fill
          ? ((l = !0), (n *= t.attributeState.fill ? 1 : 0))
          : l && !t.attributeState.fill && (n = 0),
        t.attributeState.stroke !== e.attributeState.stroke
          ? ((u = !0), (a *= t.attributeState.stroke ? 1 : 0))
          : u && !t.attributeState.stroke && (a = 0)),
    l || u)
  ) {
    var h = {};
    (l && (h.opacity = n), u && (h["stroke-opacity"] = a), t.pdf.setGState(new O$1(h)));
  }
  if (
    ...
    t.attributeState.strokeWidth !== e.attributeState.strokeWidth &&
    ...
    t.attributeState.strokeLinecap !== e.attributeState.strokeLinecap &&
      t.pdf.setLineCap(t.attributeState.strokeLinecap),
    t.attributeState.strokeLinejoin !== e.attributeState.strokeLinejoin &&
      t.pdf.setLineJoin(t.attributeState.strokeLinejoin),
    (t.attributeState.strokeDasharray === e.attributeState.strokeDasharray &&
      t.attributeState.strokeDashoffset === e.attributeState.strokeDashoffset) ||
      !t.attributeState.strokeDasharray ||
      t.pdf.setLineDashPattern(t.attributeState.strokeDasharray, t.attributeState.strokeDashoffset),
    t.attributeState.strokeMiterlimit !== e.attributeState.strokeMiterlimit &&
      t.pdf.setLineMiterLimit(t.attributeState.strokeMiterlimit),
    t.attributeState.fontFamily !== e.attributeState.fontFamily &&
  ...
  ((t.attributeState.fontWeight === e.attributeState.fontWeight &&
    t.attributeState.fontStyle === e.attributeState.fontStyle) ||
    ...
    (void 0 === s && void 0 === o) ||
      (void 0 === s &&
        (s = U.hasOwnProperty(t.attributeState.fontFamily)
          ...
          : t.attributeState.fontFamily),
      t.pdf.setFont(s, o)),
    t.attributeState.fontSize !== e.attributeState.fontSize &&
      t.pdf.setFontSize(t.attributeState.fontSize * t.pdf.internal.scaleFactor));
}
function lt(t, e, r) {
  var i = R.exec(t);
  if (i) {
        ...
        case 0:
          return (
            ...
            e.element.hasAttribute("clipPathUnits") &&
              "objectboundingbox" === e.element.getAttribute("clipPathUnits").toLowerCase() &&
    ...
    (e.prototype.render = function (t) {
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (a) {
          switch (a.label) {
            case 0:
              return this.isVisible("hidden" !== t.attributeState.visibility, t)
                ? (((e = t.clone()).transform = e.pdf.matrixMult(
                  ...
                  (i = r && "none" !== r)
                    ? (n = lt(r, 0, e))
                      ? n.isVisible(!0, e)
                        ? (e.pdf.saveGraphicsState(), [4, ut(this, n, e)])
                        : [3, 2]
                      : [3, 4]
                    : [3, 5])
                : [2];
  ...
  return (
    ...
    (e.prototype.drawMarkers = function (t, e) {
      return f(this, void 0, void 0, function () {
        return c(this, function (r) {
          switch (r.label) {
            case 0:
              return [4, this.getMarkers(e, t).draw(t.clone({ transform: t.pdf.unitMatrix }))];
            case 1:
              return (r.sent(), [2]);
          }
        });
        ...
        return c(this, function (s) {
          switch (s.label) {
            case 0:
              return t.withinClipPath
                ...
                : ((e = t.attributeState.fill),
                  (r = t.attributeState.stroke && 0 !== t.attributeState.strokeWidth),
            ...
            case 3:
              return (
                (i = n),
                (a = "evenodd" === t.attributeState.fillRule),
                (e && r) || t.withinUse
                  ? a
    ...
    (e.prototype.getBoundingBoxCore = function (t) {
      ...
      for (
        ...
        var u = e.segments[l];
        ((u instanceof T || u instanceof F || u instanceof A) && ((s = u.x), (o = u.y)),
          u instanceof A
    ...
    (e.prototype.getMarkers = function (t, e) {
      ...
      if (r || i || n) {
        ...
        for (
          var s = t.segments,
            ...
            c = function (t) {
              var e = s[t],
                c = r && (1 === t || (!(s[t] instanceof T) && s[t - 1] instanceof T));
              c &&
              ...
              var p = n && (t === s.length - 1 || (!(s[t] instanceof T) && s[t + 1] instanceof T)),
                d = i && t > 0 && !(1 === t && s[t - 1] instanceof T),
                m = s[t - 1] || null;
              if (m instanceof T || m instanceof F || m instanceof A) {
                if (e instanceof A)
                  (c &&
                    a.addMarker(
                      new I(r, [m.x, m.y], y(f ? [f.x, f.y] : [m.x, m.y], [e.x1, e.y1]), !0),
                    ),
                    p && a.addMarker(new I(n, [e.x, e.y], y([e.x2, e.y2], [e.x, e.y]))),
                    d &&
                      ((l = w([m.x, m.y], [e.x1, e.y1])),
                      (l = m instanceof T ? l : S(k(o, l))),
                      a.addMarker(new I(i, [m.x, m.y], Math.atan2(l[1], l[0])))),
                    (o = w([e.x2, e.y2], [e.x, e.y])));
                else if (e instanceof T || e instanceof F) {
                  if (((l = w([m.x, m.y], [e.x, e.y])), c)) {
                    var g = f ? w([f.x, f.y], [e.x, e.y]) : l;
                    a.addMarker(new I(r, [m.x, m.y], Math.atan2(g[1], g[0]), !0));
                  }
                ...
                u = e instanceof T && e;
                var b = s[t + 1];
                (b instanceof T || b instanceof F || b instanceof A) &&
                  (h = w([u.x, u.y], [b.x, b.y]));
              }
            },
            p = 0;
      ...
      return (
        a.markers.forEach(function (t) {
          var r = e.refsHandler.get(t.id);
          if (r) {
            var i = N(r.element, e.styleSheets, "orient");
            null != i &&
              (t.isStartMarker && "auto-start-reverse" === i && (t.angle += Math.PI),
              isNaN(Number(i)) || (t.angle = (parseFloat(i) / 180) * Math.PI));
          }
        }),
        a
      );
        ...
        return c(this, function (c) {
          switch (c.label) {
            case 0:
              return (
                (r = parseFloat),
                (i = this.element.getAttribute("href") || this.element.getAttribute("xlink:href"))
                  ? ((n = i.substring(1)),
                    (a = t.refsHandler.get(n)),
                    (s = B(a.element, "symbol,svg") && a.element.hasAttribute("viewBox")),
                    (o = r(N(this.element, t.styleSheets, "x") || "0")),
                    (l = r(N(this.element, t.styleSheets, "y") || "0")),
                    (u = void 0),
                    (h = void 0),
                    s
                      ? ((u = r(
                        ...
                        (o += r(N(a.element, t.styleSheets, "x") || "0")),
                        (l += r(N(a.element, t.styleSheets, "y") || "0")),
                        (p = j(a.element.getAttribute("viewBox"))),
                        (f = $(a.element, p, o, l, u, h, t)))
                      : (f = t.pdf.Matrix(1, 0, 0, 1, o, l)),
                    (d = m.getContextColors(t, !0)),
                    (b = new g(t.pdf, {
                      refsHandler: t.refsHandler,
                      styleSheets: t.styleSheets,
                      withinUse: !0,
            ...
            case 1:
              return (
                ...
                s &&
                  ...
                  (t.pdf.rect(o, l, u, h), t.pdf.clip().discardPath()),
                t.pdf.doFormObject(t.refsHandler.generateKey(n, d), f),
                t.pdf.restoreGraphicsState(),
                [2]
              );
          }
        ...
        return c(this, function (n) {
          switch (n.label) {
            case 0:
              return (
                (i = [
                  (i = t.getBoundingBox(r))[0] - 0.5 * i[2],
                  i[1] - 0.5 * i[3],
                  2 * i[2],
                  2 * i[3],
                ]),
                r.pdf.beginFormObject(i[0], i[1], i[2], i[3], r.pdf.unitMatrix),
                t instanceof mt ? [4, t.apply(r)] : [3, 2]
              );
            case 1:
              return (n.sent(), [3, 4]);
            case 2:
            ...
            case 3:
              (n.sent(), (n.label = 4));
            case 4:
              return (r.pdf.endFormObject(r.refsHandler.generateKey(e, r.attributeState)), [2]);
          }
        });
      });
    }),
    ...
    (e.prototype.getPath = function (t) {
      ...
      return 0 === a && 0 === s
        ...
        : new C()
            .moveTo((o += a), l)
            .lineTo((o += e - 2 * a), l)
            .curveTo(o + a * u, l, o + a, l + (s - s * u), (o += a), (l += s))
            .lineTo(o, (l += r - 2 * s))
  ...
  return (
    ...
    (t.prototype.rightTrimText = function () {
      for (var t = this.texts.length - 1; t >= 0; t--)
        if (
          ("preserve" === this.contexts[t].attributeState.xmlSpace ||
            "pre" === this.contexts[t].attributeState.whiteSpace ||
    ...
    (t.prototype.put = function (e, r) {
      ...
      for (i = 0; i < this.textNodes.length; i++)
        if (
          ((n = this.textNodes[i]),
          (a = this.contexts[i]),
          "#text" === n.nodeName || "hidden" !== a.attributeState.visibility)
        ) {
    ...
    (e.prototype.processTSpans = function (t, e, r, i, n, a) {
      for (
        var s = r.pdf.getFontSize(),
          o = "preserve" === r.attributeState.xmlSpace || "pre" === r.attributeState.whiteSpace,
          l = !0,
          u = !1,
          h = 0;
        ...
        if (f.textContent) {
          ...
          if ("#text" === f.nodeName) {
            ...
            if (null !== g) {
              ...
              ((n = new Tt(
                this,
                N(m, r.styleSheets, "text-anchor") || r.attributeState.textAnchor,
                b,
                0,
              )),
                i.push({
      ...
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (c) {
          if (
            ...
            (i = 1),
            (n = t.pdf.getFontSize()),
            (a = W(this.element.getAttribute("x"), n)),
            (s = W(this.element.getAttribute("y"), n)),
            (o = W(this.element.getAttribute("dx"), n)),
            (l = W(this.element.getAttribute("dy"), n)),
            (u = parseFloat(this.element.getAttribute("textLength") || "0")),
            (h = t.attributeState.visibility),
            ...
            ((f = this.element.textContent || ""),
              (p = (function (t, e) {
                return (
                  (t = kt((t = wt(t)))),
                  "preserve" === e.xmlSpace || "pre" === e.whiteSpace || (t = Mt((t = t.trim()))),
                  t
                );
              })(f, t.attributeState)),
              (d = Ct(this.element, p, t)),
              (e = t.textMeasure.getTextOffset(d, t.attributeState)),
              u > 0 &&
                ((m = t.textMeasure.measureTextWidth(d, t.attributeState)),
                !(
                  "preserve" === t.attributeState.xmlSpace || "pre" === t.attributeState.whiteSpace
                ) &&
                  f.match(/^\s/) &&
                  (i = 0),
                (r = (u - m) / (d.length - i) || 0)),
              "visible" === h &&
                ((g = t.attributeState.alignmentBaseline),
                (b = St(t.attributeState)),
                t.pdf.text(d, a + o - e, s + l, {
                  baseline: V(g),
                  angle: t.transform,
            ...
            for (
              y = [],
                v = new Tt(this, t.attributeState.textAnchor, a + o, s + l),
                y.push({
                  type: "",
                  chunk: v,
                }),
...
var At = (function (t) {
  ...
  return (
    ...
    (e.prototype.getPath = function (t) {
      var e,
        r,
        i = new import_svgpath.default(N(this.element, t.styleSheets, "d") || "")
          .unshort()
          .unarc()
          .abs(),
        n = new C();
...
var Bt = (function (t) {
  function e(r, i) {
    ...
    return (
      ...
      (n.imageUrl = n.element.getAttribute("xlink:href") || n.element.getAttribute("href")),
          ...
          switch (c.label) {
            case 0:
              return this.imageLoadingPromise
                ? (t.pdf.setCurrentTransformationMatrix(t.transform),
                  (r = parseFloat(N(this.element, t.styleSheets, "width") || "0")),
                  (i = parseFloat(N(this.element, t.styleSheets, "height") || "0")),
                  (n = parseFloat(N(this.element, t.styleSheets, "x") || "0")),
                  (a = parseFloat(N(this.element, t.styleSheets, "y") || "0")),
                  !isFinite(r) || r <= 0 || !isFinite(i) || i <= 0
                    ? [2]
            ...
            case 1:
              return (
                (s = c.sent()),
                (o = s.data),
                0 !== (l = s.format).indexOf("svg")
                  ? [3, 3]
                  : ((u = new DOMParser()),
                    (h = u.parseFromString(o, "image/svg+xml").firstElementChild),
                    (!(f = this.element.getAttribute("preserveAspectRatio")) ||
                      f.indexOf("defer") < 0 ||
                      !h.getAttribute("preserveAspectRatio")) &&
                      h.setAttribute("preserveAspectRatio", f || ""),
                    h.setAttribute("x", String(n)),
                    h.setAttribute("y", String(a)),
                    h.setAttribute("width", String(r)),
            ...
            case 5:
              return (
                ...
                (v = m[1]),
                (x = [0, 0, y, v]),
                (S = $(this.element, x, n, a, r, i, t)),
                t.pdf.setCurrentTransformationMatrix(S),
                t.pdf.addImage(d, "", 0, 0, y, v),
                [3, 7]
              );
            case 6:
              return (
    ...
    (e.fetchImageData = function (t) {
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (o) {
          switch (o.label) {
            case 0:
              if (!(n = t.match(Pt))) return [3, 1];
              if (((a = n[2]), "image" !== (s = a.split("/"))[0]))
                throw new Error("Unsupported image URL: ".concat(t));
              return (
                (i = s[1]),
                (r = n[5]),
                "base64" === n[4]
    ...
    (e.fetchImage = function (t) {
      return new Promise(function (e, r) {
        ...
        (i.open("GET", t, !0),
          ...
          (i.onload = function () {
            if (200 !== i.status)
              throw new Error("Error ".concat(i.status, ": Failed to load image '").concat(t, "'"));
            for (var r = new Uint8Array(i.response), n = "", a = 0; a < r.length; a++)
    ...
    (e.prototype.apply = function (t) {
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (l) {
          switch (l.label) {
            case 0:
              ((e = this.computeNodeTransform(t)),
                (r = this.getBoundingBox(t)),
                t.pdf.beginFormObject(r[0], r[1], r[2], r[3], e),
                (n = m.getContextColors(t)),
                (function (t) {
                  ...
                  ((n *= e.fillOpacity),
                    (n *= e.opacity),
                    e.fill instanceof d && void 0 !== e.fill.color.a && (n *= e.fill.color.a),
                    (a *= e.strokeOpacity),
                    (a *= e.opacity),
                    e.stroke instanceof d &&
                      void 0 !== e.stroke.color.a &&
                      (a *= e.stroke.color.a));
                  var s,
                    o = {};
                  if (
                    ((o.opacity = n),
                    (o["stroke-opacity"] = a),
                    r.setGState(new O$1(o)),
                    e.fill && e.fill instanceof d && e.fill.color.ok
                      ? r.setFillColor(e.fill.color.r, e.fill.color.g, e.fill.color.b)
                      : r.setFillColor(0, 0, 0),
                    r.setLineWidth(e.strokeWidth),
                    e.stroke instanceof d
                      ? r.setDrawColor(e.stroke.color.r, e.stroke.color.g, e.stroke.color.b)
                      : r.setDrawColor(0, 0, 0),
                    r.setLineCap(e.strokeLinecap),
                    r.setLineJoin(e.strokeLinejoin),
                    e.strokeDasharray
                      ? r.setLineDashPattern(e.strokeDasharray, e.strokeDashoffset)
                      : r.setLineDashPattern([], 0),
                    r.setLineMiterLimit(e.strokeMiterlimit),
                    (s = U.hasOwnProperty(e.fontFamily) ? U[e.fontFamily] : e.fontFamily),
                    e.fill && e.fill instanceof d && e.fill.color.ok)
                  ) {
                    var l = e.fill.color;
                  ...
                  var u = "";
                  ("bold" === e.fontWeight && (u = "bold"),
                    "italic" === e.fontStyle && (u += "italic"),
                    "" === u && (u = "normal"),
                    void 0 !== s || void 0 !== u
                      ? (void 0 === s &&
                          (s = U.hasOwnProperty(e.fontFamily) ? U[e.fontFamily] : e.fontFamily),
                        r.setFont(s, u))
                      : r.setFont("helvetica", u),
                    r.setFontSize(e.fontSize * r.internal.scaleFactor));
                })(
                  (a = new g(t.pdf, {
                    refsHandler: t.refsHandler,
                    styleSheets: t.styleSheets,
                ...
                (l.label = 1));
            case 1:
              return s < o.length ? [4, o[s].render(a)] : [3, 4];
            case 2:
              (l.sent(), (l.label = 3));
            case 3:
              return (s++, [3, 1]);
            case 4:
              return (
                t.pdf.endFormObject(a.refsHandler.generateKey(this.element.getAttribute("id"), n)),
                [2]
              );
          }
        });
    ...
    (e.prototype.render = function (e) {
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (o) {
          switch (o.label) {
            case 0:
              return this.isVisible("hidden" !== e.attributeState.visibility, e)
                ? ((r = this.getX(e)),
                  (i = this.getY(e)),
                  (n = this.getWidth(e)),
                  (a = this.getHeight(e)),
                  ...
                  this.element.hasAttribute("transform") &&
                    (s = e.pdf.matrixMult(Q(this.element.getAttribute("transform"), e), s)),
                  e.pdf.setCurrentTransformationMatrix(s),
                  e.withinUse ||
                    "visible" === N(this.element, e.styleSheets, "overflow") ||
...
var Vt = (function (t) {
  ...
  return (
    u(e, t),
    (e.prototype.renderCore = function (e) {
      return f(this, void 0, void 0, function () {
        var r, i, n, a;
        return c(this, function (s) {
          switch (s.label) {
            case 0:
              return [4, t.prototype.renderCore.call(this, e)];
            case 1:
              return (
                s.sent(),
                (r = N(this.element, e.styleSheets, "href")) &&
                  ((i = this.getBoundingBox(e)),
                  (n = e.pdf.internal.scaleFactor),
                  (a = e.pdf.internal.pageSize.getHeight()),
                  e.pdf.link(
                    n * (i[0] * e.transform.sx + e.transform.tx),
                    a - n * (i[1] * e.transform.sy + e.transform.ty),
                    n * i[2],
                    n * i[3],
                    { url: r },
                  )),
        ...
        return c(this, function (s) {
          switch (s.label) {
            case 0:
              ...
              ((e = t.pdf.matrixMult(this.computeNodeTransform(t), t.transform)),
            ...
            case 4:
              return (
                (n =
                  ...
                  !!N(this.children[0].element, t.styleSheets, "clip-rule")),
                (a = n
                  ? this.getClipRuleAttr(this.children[0].element, t.styleSheets)
                  : this.getClipRuleAttr(this.element, t.styleSheets)),
                t.pdf.clip(a).discardPath(),
...
function Gt(e, r) {
  ...
  if (null != r && i.element.hasAttribute("id")) {
    var a = (0, import_cssesc.default)(i.element.id, { isIdentifier: !0 });
    r[a] = r[a] || i;
  }
  return (
...
var Ut = (function () {
  ...
  return (
    ...
    (t.prototype.collectStyleSheetTexts = function () {
      return f(this, void 0, void 0, function () {
        ...
        return c(this, function (s) {
          switch (s.label) {
            case 0:
              if (((e = []), this.loadExternalSheets && this.rootSvg.ownerDocument))
                for (n = 0; n < this.rootSvg.ownerDocument.childNodes.length; n++)
                  "xml-stylesheet" === (r = this.rootSvg.ownerDocument.childNodes[n]).nodeName &&
    ...
    (t.prototype.parseCssSheets = function (e) {
      for (
        var r = document.implementation.createHTMLDocument(""), i = 0, n = e;
        i < n.length;
        i++
      ) {
        var a = n[i],
        ...
        switch (s) {
          case "initial":
            ((r.lastIndex = u),
              (e = r.exec(t))
                ? ("," === e[0]
                    ? (a.push(t.substring(o + 1, r.lastIndex - 1).trim()), (o = r.lastIndex - 1))
    ...
    (t.loadSheet = function (t) {
      return new Promise(function (e, r) {
        ...
        (i.open("GET", t, !0),
          ...
          (i.onload = function () {
            (200 !== i.status &&
              r(new Error("Error ".concat(i.status, ": Failed to load '").concat(t, "'"))),
              e(i.responseText));
          }),
          (i.onerror = r),
          (i.onabort = r),
        ...
        return (
          r
            .reduce(function (t, r) {
              return 1 ===
                ((n = r),
                (a = (i = t).style.getPropertyPriority(e)) !== n.style.getPropertyPriority(e)
                  ? "important" === a
                    ? 1
                    : -1
                  : compare(i.selectorText, n.selectorText))
                ? t
                : r;
              var i, n, a;
            })
    ...
    (t.prototype.getMeasureFunction = function (e) {
      ...
      if (!r) {
        var i = "16px",
          n = "normal",
          a = "normal",
          s = this.canvasTextMeasure(t.testString, e, i, n, a),
          o = this.svgTextMeasure(t.testString, e, i, n, a);
        ((r = Math.abs(s - o) < t.epsilon ? this.canvasTextMeasure : this.svgTextMeasure),
    ...
    return (
      ...
      c(this, function (c) {
        switch (c.label) {
          case 0:
            return (
              (i = null !== (y = r.x) && void 0 !== y ? y : 0),
              (n = null !== (v = r.y) && void 0 !== v ? v : 0),
              (a = null !== (x = r.loadExternalStyleSheets) && void 0 !== x && x),
              (o = new b((s = {}))),
              [4, (l = new Ut(t, a)).load()]
            );
          case 1:
            return (
              c.sent(),
              (u = new gt(e.internal.pageSize.getWidth(), e.internal.pageSize.getHeight())),
              (f = h(h({}, r), { element: t })),
              (p = new zt()),
              (d = new g(e, {
                refsHandler: o,
              ...
              e.advancedAPI(),
              e.saveGraphicsState(),
              e.setCurrentTransformationMatrix(e.Matrix(1, 0, 0, 1, i, n)),
              e.setLineWidth(d.attributeState.strokeWidth),
              (m = d.attributeState.fill.color),
              e.setFillColor(m.r, m.g, m.b),
              e.setFont(d.attributeState.fontFamily),
              e.setFontSize(d.attributeState.fontSize * e.internal.scaleFactor),
              [4, Gt(t, s).render(d)]
            );
          case 2:
            return (
              ...
              e.compatAPI(),
              d.textMeasure.cleanupTextMeasuring(),
              [2, e]
            );
        }
      })
...
E$1.API.svg = function (t, e) {
  return (void 0 === e && (e = {}), Yt(t, this, e));
};
//#endregion
export { Yt as svg2pdf };
