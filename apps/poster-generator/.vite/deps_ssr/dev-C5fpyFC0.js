import {
  Cr as missing_context,
  Ln as get_stack,
  Qn as STALE_REACTION,
  Sr as lifecycle_outside_component,
  mr as noop,
  pr as is_promise,
  rr as deferred,
  t as subscribe_to_store,
  ur as has_own_property,
  xr as invalid_snippet_arguments,
} from "./utils-eAam9OGe.js";
import { t as async_mode_flag } from "./flags-0VUX__9w.js";
import { l as UNINITIALIZED, n as FILENAME } from "./constants-CryMY321.js";
import {
  i as EMPTY_COMMENT,
  n as BLOCK_OPEN,
  o as is_tag_valid_with_ancestor,
  r as BLOCK_OPEN_ELSE,
  s as is_tag_valid_with_parent,
  t as BLOCK_CLOSE,
} from "./hydration-Bj_lZxG7.js";
import {
  _ as is_void,
  a as is_boolean_attribute,
  b as escape_html,
  f as is_raw_text_element,
  i as hash,
  t as REGEX_VALID_TAG_NAME,
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/server/warnings.js
...
//#endregion
//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/internal/server/blocks/html.js
/**
 * @param {string} value
 */
function html(value) {
  ...
  if (parent !== void 0) {
    ...
    while (ancestor != null) {
      ...
      const message = is_tag_valid_with_ancestor(
        ...
        ancestors,
        child_loc,
        ancestor.filename ? `${ancestor.filename}:${ancestor.line}:${ancestor.column}` : void 0,
      );
      if (message) print_error(renderer, message);
...
export {
  ...
  setContext as H,
  getAbortSignal as I,
  lifecycle_function_unavailable as K,
  createContext as L,
  update_store_pre as M,
  html as N,
