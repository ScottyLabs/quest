//#region ../../node_modules/.deno/svelte@5.56.8/node_modules/svelte/src/html-tree-validation.js
/**
...
function is_tag_valid_with_ancestor(child_tag, ancestors, child_loc, ancestor_loc) {
  ...
  if ("descendant" in disallowed && disallowed.descendant.includes(child_tag))
    return `${child_loc ? `\`<${child_tag}>\` (${child_loc})` : `\`<${child_tag}>\``} cannot be a descendant of ${ancestor_loc ? `\`<${ancestor_tag}>\` (${ancestor_loc})` : `\`<${ancestor_tag}>\``}`;
  return null;
}
/**
...
//#endregion
export {
  closing_tag_omitted as a,
  EMPTY_COMMENT as i,
  BLOCK_OPEN as n,
  is_tag_valid_with_ancestor as o,
  BLOCK_OPEN_ELSE as r,
  is_tag_valid_with_parent as s,
  BLOCK_CLOSE as t,
};
