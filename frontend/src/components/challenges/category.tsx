...
import {
	type Challenge,
	useChallengesByCategory,
} from "@/components/challenges/layout";
...
function ChallengeCard({ challenge, categoryId, isLast }: ChallengeCardProps) {
	...
	return (
		<div className={`flex flex-row gap-6 ${isLast && "mb-32"}`}>
...
export function ChallengeCategory({ categoryId }: CategoryProps) {
	...
	return (
		<div className="px-4 pt-6 max-w-xl mx-auto">
			<div className="[view-transition-name:main-content] flex flex-col gap-4">
